...
<body>
  <div class="privew">
    <div class="questionsBox">
      <div class="questions">Qu'obtient-on après le premier top 1</div>
      <div class="funkyradio">
        <form action="" method="POST">
          <div class="funkyradio-default">
            <input type="radio" name="radio_1" id="radio1" />
            <label for="radio1">Un skin</label>
          </div>
          <div class="funkyradio-default">
            <input type="radio" name="radio_2" id="radio2" />
            <label for="radio2">Une pioche</label>
          </div>
          <div class="funkyradio-default">
            <input type="radio" name="radio_3" id="radio3" />
            <label for="radio3">De l'argent</label>
          </div>
          <div class="funkyradio-default">
            <input type="radio" name="radio_v" id="radio_v" />
            <label for="radio_v">Un parapluie</label>
          </div>
        </div>
